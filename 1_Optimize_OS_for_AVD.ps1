 ...
 $updatePath= "C:\optimize\Virtual-Desktop-Optimization-Tool-master\Windows_VDOT.ps1"
 ...
 # run script
  .\optimize.ps1 -Optimizations All -AdvancedOptimizations Edge -Verbose -AcceptEULA
